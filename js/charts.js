...
// 3. Create a variable that holds the washing frequency. - For Gauge Chart
    ...
    var barLayout = {      
        title: "<b>Top 10 Bacterial Species</b>",
...
// Deliverable 3: Gauge Chart
      ...
      var gaugeData = [{
        ...
        gauge: {
          ...
          bar: { color: "black" },
          steps: [
            { range: [0, 2], color: "#C95461" },
            { range: [2, 4], color: "#D98575" },
            { range: [4, 6], color: "#E0C8B6" },
            { range: [6, 8], color: "#8EA3F1" },
            { range: [8, 10], color: "#5054C5" }]
        },
